...
/*
    parsing.ino V0.0.2
    GPS Program for Autonomous Multi-Sensor Information Fusion
...
*/
/**************************************************************************/
// void myFile.print(int &num) {
//   myFile.print(num);
//   myFile.print(",");
// }
// void myFile.print(double &num) {
//   myFile.print(num, 4);
//   myFile.print(",");
// }
// void myFile.print(long unsigned int num) {
//   myFile.print(num);
//   myFile.print(",");
// }
...
void loop()                     // run over and over again
{
  ...
  if (millis() - timer > 2000) { 
    ...
    //myFile.print("\nTime: ");
    myFile.print(GPS.hour, DEC); myFile.print(","); //myFile.print(':');
    myFile.print(GPS.minute, DEC); myFile.print(","); //myFile.printt(':');
    myFile.print(GPS.seconds, DEC); myFile.print(","); //myFile.print('.');
    ...
    myFile.print((int)GPS.fixquality); myFile.print(","); 
    //Time Since Turned On (ms)   So this is how ALex did timing of sensors
    myFile.print(millis()); myFile.print(","); 
    if (GPS.fix) {
      //Serial.print("Location: ");
      myFile.print(GPS.latitude, 4); myFile.print(","); 
      myFile.print(GPS.lat); myFile.print(","); 
      myFile.print(GPS.longitude, 4); myFile.print(","); 
      myFile.print(GPS.lon); myFile.print(","); 
      //Serial.print("Location (in degrees, works with Google Maps): ");
      myFile.print(GPS.latitudeDegrees, 4); myFile.print(","); 
      myFile.print(GPS.longitudeDegrees, 4); myFile.print(","); 
